                        ...
                        <div class="uk-width-small-1-1 uk-width-medium-3-4 uk-width-large-7-10">
                            <div id="index" class="bs uk-text-break">
                                ...
                                <div id="list" class="category">
                                    <p class="date"><strong>${blog.name}</strong>目前共有分类：&nbsp;${fn:length(blog.classify)}  </p>
                                    <c:forEach items="${blog.classify}" var="classify">
                                        <a id="lc" href="../q_action/select_classify?id=${classify.id}&username=${blog.username}"  data-uk-tooltip>${classify.name}</a>
                                    </c:forEach>
                                </div>
                            </div>
    ...
    <div id="my-link" class="uk-modal">
        <div class="uk-modal-dialog">
            ...
            <ul id="link_qzhai" class=" uk-subnav uk-subnav-line">
                <li id="menu-item-40" class=""><a href="#" class="qzhai_bgc_hover">大眼睛</a></li>
