                ...
                <div class=" col-sm-10 col-sm-offset-1  ">
                    <div class="panel panel-primary ">
                        <div class=" panel-heading">
                            <span class="panel-title">我的标签</span>

                        </div>
                        <div class=" panel-body">
                            <div style="padding:5px 10px;">
                                <c:forEach items="${label}" var="label">
                                <span class="pull-left">${label.name}</span>
                                <span class="pull-right"><a class="btn btn-xs btn-danger" href="../delete/label?id=${label.id}">删除</a></span><br><br>
                                </c:forEach>
                            </div>
