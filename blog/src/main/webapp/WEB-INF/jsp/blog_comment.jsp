                    ...
                    <div class=" col-sm-10 col-sm-offset-1  ">
                        <div class="panel panel-primary ">
                            <div class=" panel-heading">
                                <span class="panel-title">文章评论</span>
                        ...
                        <div class=" panel-body">
                         ...
                         <div>
                           ...
                           <div class="row" >
                             <span class="col-sm-5 text-success ">${text.title}</span><span class="col-sm-4 "><time><i class="iconfont icon-rili"></i>&nbsp;${text.date}</time></span>
                           </div><br>
                             <c:forEach items="${text_comment}" var="c">


                           <div class="row"  style="border-top: 1px solid #ccc;padding:10px 0;" >

                               <p class="col-sm-11 col-sm-offset-1" style="padding: 0 10px;color: #666666; text-indent:15px;"  >${c.details}</p>
                               <p class="col-sm-11 col-sm-offset-1" style="padding: 0 10px;color: #666666; "  ><span class=" pull-right"><span class="text-primary">${c.name}</span>&nbsp;&nbsp;&nbsp;&nbsp;<time><i class="iconfont icon-rili"></i>&nbsp;${c.date}</time>&nbsp;&nbsp;<a href="#" class="btn btn-xs btn-success">回复</a>&nbsp;&nbsp;<a href="../delete/comment?id=${c.id}&text_id=${text.id}" class="btn btn-xs btn-danger">删除</a></span></p>
