            ...
            <div id="index" class="bs uk-text-break">
                ...
                <div id="qzhai_comments">
                    <div id="respond" class="comment_form" role="form">
                        <p id="reply-title" class="comments-title">发表留言</p>
                        <form action="#" method="post" class="uk-form" id="commentform" >
                            <div class="textarea_qzhai">


                                <textarea id="comment"  placeholder="内容.." tabindex="1" name="value"></textarea>
                            </div>
                            <div class="text uk-grid uk-grid-small">
                                <div class="uk-width-medium-1-4 uk-form-icon">
                                    ...
                                    <input id="author" type="text" tabindex="2" value="" name="name" placeholder="昵称*" class="uk-width-1-1" />
                                </div>
                                <div class=" uk-width-medium-1-4 uk-form-icon">
                                ...
                                <div class="uk-width-medium-1-4 uk-form-icon">
                                    ...
                                    <input style="display: none;" id="url" type="text" tabindex="4" value="${blog.username}" name="username"  class="uk-width-1-1" />
                                </div>
                                <div class="uk-width-medium-1-4">
                                    <button name="submit" type="submit" id="submit" class="uk-button uk-width-1-1" tabindex="5">发表</button>
                                </div>
                            </div>
                            <div class="uk-margin-small-top">
                                <div style="margin-top:5px;">
                                    <input type="checkbox" name="comment_mail_notify" id="comment_mail_notify" value="comment_mail_notify" checked="checked" style="margin-right:5px;" />
                                    <label for="comment_mail_notify">通过邮件回复我</label>
                                </div>
                            </div>
