    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
        <ul class="nav sidebar-nav">
            ...
            <li>
                ...
                <a href="../action/reindex"><i class="fa fa-fw fa-home"></i> Home</a>
            </li>
            <li>
                <a href="../action/blog_list"><i class="fa fa-fw fa-folder"></i> Blogs</a>
            </li>
            <li>
                <a href="../action/write"><i class="fa fa-fw fa-file-o"></i> Writing a blog</a>
            </li>
            <li>
                <a href="../action/account"><i class="fa fa-fw fa-cog"></i> Edit Account</a>
            </li>
            ...
            <li >
                <a href="../action/classInsert"><i class="fa fa-fw fa-bank"></i> Add Classify</a>
            </li>
            <li >
                <a href="../action/labelInsert"><i class="fa fa-fw fa-bank"></i> Add Lable</a>
            </li>
            <li >
                <a href="../action/class"><i class="fa fa-fw fa-dropbox"></i> Classify</a>
            </li>
            <li >
                <a href="../action/blog_label"><i class="fa fa-fw fa-dropbox"></i> Label</a>
            </li>
            <li>
                <a href="../action/blog_message"><i class="fa fa-fw fa-twitter"></i> Guestbook</a>
            </li>
        </ul>
    </nav>
    <!-- /#sidebar-wrapper -->
                ...
                <div class=" col-sm-10 col-sm-offset-1  ">
                    <div class="panel panel-default ">
                        <div class=" panel-heading">
                            <span class="panel-title">My Guestbook</span>
                        ...
                        <div class=" panel-body">
                            ...
                            <form role="role" action="../upload/text" method="post" name="upfile">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="classfy" class="form-control">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="label" class="form-control">
                                        <option value="开心">标签1</option>
                                        <option value="网络">标签2</option>
                                        -j
                                    </select>
                                </div><br>
