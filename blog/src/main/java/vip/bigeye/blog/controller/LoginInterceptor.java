...
public class LoginInterceptor implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        .excludePathPatterns("/insert/blog")
        .excludePathPatterns("/insert/message")
        .excludePathPatterns("/insert/comment")
        .excludePathPatterns("/insert/likes")
        .excludePathPatterns("/login/blog")
        .excludePathPatterns("/util/*")
        .excludePathPatterns("/q_action/**");
    }
