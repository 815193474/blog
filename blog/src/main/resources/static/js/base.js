    ...
    xmlHttp.onreadystatechange=function() {
        ...
        if (xmlHttp.readyState == 4) {
            ...
            if (xmlHttp.status == 200) {
                ...
                document.getElementById("li-comment-53").innerHTML=xmlHttp.responseText;  //重设页面中id="content"的div里的内容
...
function su() {
    ...
    var url1="../insert/comment?id="+id+"&username="+username+"&details="+comment+"&author="+author;
    showAtRight(url1);
